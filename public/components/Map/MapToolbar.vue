...
import CommonUtils from '../../utils/base/function'
import { mapTools, mapToolsClosed } from "./tools";
let myTools = reactive(CommonUtils.deepClone(mapTools));

const curIndex = ref(-1);

let isOpen = true;

const emits = defineEmits(["on-toolChange"]);
...
const handleSelChange = (e) => {
    ...
    if (e === "工具条") {
        ...
        if (isOpen) {
            ...
            myTools.splice(0);
            myTools.push(CommonUtils.deepClone(mapToolsClosed));
        }
    }
};
